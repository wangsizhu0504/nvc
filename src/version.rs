...
impl Version {
    ...
    pub fn installation_path(&self, config: &config::NvcConfig) -> std::path::PathBuf {
        match self {
    ...
    pub fn root_path(&self, config: &config::NvcConfig) -> Option<std::path::PathBuf> {
