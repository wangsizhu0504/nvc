...
impl UserVersion {
    ...
    pub fn matches(&self, version: &Version, config: &crate::config::NvcConfig) -> bool {
        match (self, version) {
...
mod tests {
    ...
    fn test_major_to_version() {
        ...
        let result = UserVersion::OnlyMajor(6).to_version(&versions, &NvcConfig::default());
    ...
    fn test_major_minor_to_version() {
        ...
        let result = UserVersion::MajorMinor(6, 0).to_version(&versions, &NvcConfig::default());
    ...
    fn test_semver_to_version() {
        ...
        let result =
            UserVersion::Full(expected.clone()).to_version(&versions, &NvcConfig::default());
